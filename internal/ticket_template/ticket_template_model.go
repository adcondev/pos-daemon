...
type TicketTemplateData struct {
	...
	RazonSocialSize    int          `json:"razon_social_size,string"`
	DatosSize          int          `json:"datos_size,string"`
	VerLogotipo        adt.BoolFlex `json:"ver_logotipo"`
	LogoWidth          int          `json:"logo_width,string"`
	...
	VerLeyenda         adt.BoolFlex `json:"ver_leyenda"`
	...
	IncluyeImpuestos   adt.BoolFlex `json:"incluye_impuestos"`
	...
	VerImpuestos       adt.BoolFlex `json:"ver_impuestos"`
	VerImpuestosTotal  adt.BoolFlex `json:"ver_impuestos_total"`
}
